...
VALUES (1, 1, 'Hvide Sande, Dänemark', 56.00, 8.13, '25 EUR', 2, 1, 1, 1, 1);

-- Angebot 2: Søndervig (Entwurf)
INSERT OR IGNORE INTO offers (id, owner_id, address, lat, lon, price, beds, has_sauna, is_published)
VALUES (2, 1, 'Søndervig Beach', 56.12, 8.11, 'Kiste Bier', 4, 0, 0);

-- Angebot 3: Klitmøller (Fremd)
INSERT OR IGNORE INTO offers (id, owner_id, address, lat, lon, price, beds, has_sauna, is_published)
VALUES (3, 2, 'Cold Hawaii, Klitmøller', 57.04, 8.56, '50 EUR', 1, 1, 1);